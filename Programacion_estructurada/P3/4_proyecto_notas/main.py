        ...
        if opcion == '1' or opcion=="CREAR":
            ...
            if len (lista_nota)>0:
                ...
                for fila in lista_nota:
                    ...
                    print(f"{fila[0]:<10}{fila[2]:<30}{fila[3]:<30}{fecha:<20}")
                    print(f"_"*100)
            else:
            ...
            funciones.borrarPantalla()
            id = input("Ingresa el ID de la nota que deseas buscar: ").strip()
            respuesta = nota.buscar(id)
            if respuesta:
                print(f"\n\tMostrar la nota con ID {id}")
                print(f"{'ID':<10}{'Titulo':<30}{'Descripción':<30}{'Fecha':<20}")
                print("_" * 100)
